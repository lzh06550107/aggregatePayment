...
public class WeiXinPayUtil {
     ...
     * @return
     */
    public static Map<String, Object> appletPay(String outTradeNo, String body, BigDecimal totalAmount, String spbillCreateIp, String notifyUrl, String openid, List<GoodsDetails> goodsDetails) {
        String nonce_str = getnonceStr();
        ...
        if (goodsDetails != null && !goodsDetails.isEmpty()) {
            ...
            for (GoodsDetails goodsDetail : goodsDetails) {
