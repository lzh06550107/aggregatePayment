...
public class RpTradePaymentQueryServiceImpl implements RpTradePaymentQueryService {
	...
	public OrderPayResultVo getPayResult(String payKey, String orderNo) {
		...
		TradePaymentRecord rpTradePaymentRecord = rpTradePaymentRecordDao.getSuccessRecordByMerchantNoAndMerchantOrderNo(rpTradePaymentOrder.getMerchantNo(), rpTradePaymentOrder.getMerchantOrderNo());
