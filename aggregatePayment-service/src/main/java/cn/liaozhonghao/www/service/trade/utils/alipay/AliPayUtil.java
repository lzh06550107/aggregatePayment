package cn.liaozhonghao.www.service.trade.utils.alipay;

import cn.liaozhonghao.www.common.core.utils.StringUtil;
import cn.liaozhonghao.www.service.reconciliation.utils.alipay.MD5;
...
import cn.liaozhonghao.www.service.trade.utils.alipay.util.httpClient.HttpProtocolHandler;
import cn.liaozhonghao.www.service.trade.utils.alipay.util.httpClient.HttpRequest;
import cn.liaozhonghao.www.service.trade.utils.alipay.util.httpClient.HttpResponse;
import cn.liaozhonghao.www.service.trade.utils.alipay.util.httpClient.HttpResultType;
...
public class AliPayUtil {
     ...
     * @return
     */
    public static Map<String, Object> tradePay(String outTradeNo, String authCode, String subject, BigDecimal amount, String body, List<GoodsDetails> roncooPayGoodsDetailses) {
        logger.info("======>支付宝被扫");
        ...
        if (roncooPayGoodsDetailses != null && roncooPayGoodsDetailses.size() > 0) {
            ...
            for (GoodsDetails roncooPayGoodsDetails : roncooPayGoodsDetailses) {
