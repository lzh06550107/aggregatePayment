...
drop table if exists ap_account_history;

drop table if exists ap_pay_product;

drop table if exists ap_pay_way;

drop table if exists ap_sett_daily_collect;

drop table if exists ap_sett_record;

drop table if exists ap_sett_record_annex;

drop table if exists ap_user_bank_account;

drop table if exists ap_user_info;

drop table if exists ap_user_pay_config;

drop table if exists ap_user_pay_info;

drop table if exists ap_account_check_batch;

drop table if exists ap_account_check_mistake;

drop table if exists ap_account_check_mistake_scratch_pool;

drop table if exists ap_notify_record;

drop table if exists ap_notify_record_log;

drop table if exists ap_refund_record;

drop table if exists ap_trade_payment_order;

drop table if exists ap_trade_payment_record;
...
alter table ap_account comment '资金账户表';

/*==============================================================*/
/* table: ap_account_history                                    */
/*==============================================================*/
create table ap_account_history
(
   id                   varchar(50) not null,
   create_time          datetime not null,
   edit_time            datetime,
...
alter table ap_account_history comment '资金账户流水表';

/*==============================================================*/
/* table: ap_pay_product                                        */
/*==============================================================*/
create table ap_pay_product
(
   id                   varchar(50) not null,
   create_time          datetime not null,
   edit_time            datetime,
...
alter table ap_pay_product comment '支付产品表';

/*==============================================================*/
/* table: ap_pay_way                                            */
/*==============================================================*/
create table ap_pay_way
(
...
alter table ap_pay_way comment '支付方式';

/*==============================================================*/
/* table: ap_sett_daily_collect                                 */
/*==============================================================*/
create table ap_sett_daily_collect
(
   id                   varchar(50) not null comment 'id',
...
alter table ap_sett_daily_collect comment '每日待结算汇总';

/*==============================================================*/
/* table: ap_sett_record                                        */
/*==============================================================*/
create table ap_sett_record
(
   id                   varchar(50) not null comment 'id',
   version              int not null default 0 comment '版本号',
   create_time          datetime not null comment '创建时间',
...
alter table ap_sett_record comment '结算记录';

/*==============================================================*/
/* table: ap_sett_record_annex                                  */
/*==============================================================*/
create table ap_sett_record_annex
(
   id                   varchar(50) not null,
   create_time          datetime not null,
   edit_time            datetime,
...
/*==============================================================*/
/* table: ap_user_bank_account                                  */
/*==============================================================*/
create table ap_user_bank_account
(
   id                   varchar(50) not null,
   create_time          datetime not null,
   edit_time            datetime,
...
alter table ap_user_bank_account comment '用户银行账户表';
...
alter table ap_user_info comment '该表用来存放用户的基本信息';

/*==============================================================*/
/* table: ap_user_pay_config                                    */
/*==============================================================*/
create table ap_user_pay_config
(
   id                   varchar(50) not null,
   create_time          datetime not null,
   edit_time            datetime,
...
alter table ap_user_pay_config comment '支付设置表';

/*==============================================================*/
/* table: ap_user_pay_info                                      */
/*==============================================================*/
create table ap_user_pay_info
(
...
alter table ap_user_pay_info comment '该表用来存放用户开通的第三方支付信息';


create table ap_account_check_batch
(
   id                   varchar(50) not null,
...
alter table ap_account_check_batch comment '对账批次表 ap_account_check_batch';

create table ap_account_check_mistake
(
   id                   varchar(50) not null,
   version              int unsigned not null,
   create_time          datetime not null,
...
alter table ap_account_check_mistake comment '对账差错表 ap_account_check_mistake';

create table ap_account_check_mistake_scratch_pool
(
   id                   varchar(50) not null,
   version              int unsigned not null,
   create_time          datetime not null,
...
alter table ap_account_check_mistake_scratch_pool comment '差错暂存池';

create table ap_notify_record
(
   id                   varchar(50) not null,
...
alter table ap_notify_record comment '通知记录表 ap_notify_record';

create table ap_notify_record_log
(
   id                   varchar(50) not null,
   version              int not null,
   editor               varchar(100) comment '修改者',
...
alter table ap_notify_record_log comment '通知记录日志表 ap_notify_record_log';

create table ap_refund_record
(
   id                   varchar(50) not null comment 'id',
...
alter table ap_refund_record comment '退款记录表';

create table ap_trade_payment_order
(
   id                   varchar(50) not null comment 'id',
   version              int not null default 0 comment '版本号',
   create_time          datetime not null comment '创建时间',
...
alter table ap_trade_payment_order comment 'roncoo pay 龙果支付 支付订单表';

create table ap_trade_payment_record
(
   id                   varchar(50) not null comment 'id',
   version              int not null default 0 comment '版本号',
   create_time          datetime comment '创建时间',
...
alter table ap_trade_payment_record comment '支付记录表';
...
values (1, 0, 'ACTIVE','roncoo','2016-06-03 11:07:43', 'admin','2016-06-03 11:07:43', '超级管理员', 'admin', '13b99ae06765b31ec9b09beae190e7ff','超级管理员', '18620936193', 'ADMIN','8d78869f470951332959580424d4bf4f');
...
alter table ap_user_pay_info add offline_app_id varchar(50);
alter table ap_user_pay_info add rsa_private_key varchar(100);
alter table ap_user_pay_info add rsa_public_key varchar(100);

-- 2016.9.5 增加登录信息字段
alter table ap_user_info add mobile varchar(15);
alter table ap_user_info add password varchar(50);

-- 2017.4.4 用户信息表增加支付密码字段
alter table ap_user_info add pay_pwd varchar(50) comment '支付密码' default '123456';

-- 2017.4.5 增加用户支付配置表安全等级字段 商户服务器IP字段
alter table ap_user_pay_config add security_rating varchar(20)  comment '安全等级' default 'MD5';

alter table ap_user_pay_config add merchant_server_ip varchar(200) comment '商户服务器IP';

/*==============================小微商户进件==start=================================*/
drop table if exists ap_micro_submit_record;
create table ap_micro_submit_record
(
...
alter table ap_micro_submit_record comment '小微商户进件记录';
/*==============================小微商户进件==end=================================*/
