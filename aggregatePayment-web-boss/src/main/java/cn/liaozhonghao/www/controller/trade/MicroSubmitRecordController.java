...
import cn.liaozhonghao.www.service.weixin.UploadUtils;
...
public class MicroSubmitRecordController {
    ...
    public void list(HttpServletRequest request, MicroSubmitRecord rpMicroSubmitRecord, PageParam pageParam, Model model) {
...
//    @RequiresPermissions("trade:micro:submit:record:add")
    ...
    public String addUI(Model model) {
        model.addAttribute("wxCityNoList", WxCityNo1.getList());
    ...
    public String add(Model model, MicroSubmitRecord rpMicroSubmitRecord, DwzAjax dwz) {
