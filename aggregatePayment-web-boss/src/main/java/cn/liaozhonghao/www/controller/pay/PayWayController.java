...
public class PayWayController {
	...
	public String list(PayWay rpPayWay, PageParam pageParam, Model model) {
		...
		PayProduct rpPayProduct = rpPayProductService.getByProductCode(rpPayWay.getPayProductCode(), null);
	...
	public String add(Model model, PayWay rpPayWay, DwzAjax dwz) {
	...
	public String editUI(Model model, @RequestParam("id") String id) {
		PayWay rpPayWay = rpPayWayService.getDataById(id);
		model.addAttribute("PayWayEnums", PayWayEnum.toList());
		model.addAttribute("PayTypeEnums", PayTypeEnum.toList());
		model.addAttribute("rpPayWay", rpPayWay);
		return "pay/way/edit";
	...
	public String edit(Model model, PayWay rpPayWay, DwzAjax dwz) {
		PayWay rpPayWayOld = rpPayWayService.getDataById(rpPayWay.getId());
